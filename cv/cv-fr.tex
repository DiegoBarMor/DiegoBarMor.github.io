...
\begin{rSection}{Expérience}
    ...
    }{03.2023-02-2024}{Caractérisation des sites de liaison et leur visualisation avec Unity/C\#.}{Paris, France}
    \end{rSubsectionShort}
...
\begin{rSection}{Compétences}
    ...
    \begin{itemize}
        \item \textbf{Niveau élevé :} Python, Bash, Git.
        \item \textbf{Niveau intermédiaire :} LaTeX, Markdown, HTML, Javascript, CSS, \\ Fortran, C, C\#, C++, Java, Kotlin, regex.
        \item \textbf{Notions :} Batch, R, MATLAB, Tcl, Rust, Lua, GLSL.
    \end{itemize}

    \subsection*{Langues :}
    \begin{itemize}
        \item \textbf{Courant :} Espagnol (natif), Anglais (C1.2), Italien.
        \item \textbf{Notions :} Allemand, Français.
    \end{itemize}
\end{rSection}
